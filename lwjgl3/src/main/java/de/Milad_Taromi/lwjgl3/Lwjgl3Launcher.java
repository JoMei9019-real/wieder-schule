...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        //configuration.setWindowIcon("libgdx128.png", "libgdx64.png", "libgdx32.png", "libgdx16.png");   //ICON!
        configuration.setWindowIcon("ui/menu/LogoWindows.PNG");
...
//        configuration.setOpenGLEmulation(Lwjgl3ApplicationConfiguration.GLEmulation.ANGLE_GLES20, 0, 0);
        ...
        configuration.setWindowedMode(852, 805);    //652x705
        //configuration.setWindowSizeLimits(652, 705, 1000, 1000);
        //configuration.setDecorated(false);       //bar
        //configuration.setMaximized(false);      //fullscreen
        configuration.setResizable(false);      //größe?
